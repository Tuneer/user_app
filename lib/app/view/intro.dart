        ...
        return Builder(
          builder: (BuildContext context) {
            return Container(
              ...
              child: Column(
                children: [
                  if (i == 0) _buildSlide1(context) else if (i == 1) _buildSlide2(context) else if (i == 2) _buildSlide3(context) else if (i == 3) _buildSlide4(context) else if (i == 4) _buildSlide5(context),
                  _buildDots()
                ],
              ),
            );
